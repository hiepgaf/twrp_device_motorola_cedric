...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt device/motorola/cedric/dt.img
BOARD_CUSTOM_BOOTIMG_MK := device/motorola/cedric/mkbootimg.mk
TARGET_PREBUILT_KERNEL := device/motorola/cedric/kernel
